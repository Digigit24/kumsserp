...
import { useBankPayments, useCreateBankPayment, useUpdateBankPayment, useDeleteBankPayment } from '../../hooks/useFees';
...
const BankPaymentsPage = () => {
  ...
  // Fetch bank payments using real API
  const { data, isLoading, error, refetch } = useBankPayments(filters);
  ...
  const handleDelete = async () => {
    ...
    if (confirm('Are you sure you want to delete this bank payment?')) {
      try {
