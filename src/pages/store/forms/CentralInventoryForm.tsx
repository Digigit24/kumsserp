    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <Input
            id="central_store"
            type="number"
            {...register('central_store', { required: 'Store is required', valueAsNumber: true })}
          />
        ...
        <div>
          ...
          <Input
            id="item"
            type="number"
            {...register('item', { required: 'Item is required', valueAsNumber: true })}
          />
      ...
      <div className="grid grid-cols-3 gap-4">
        <div>
          ...
          />
          {errors.quantity_on_hand && <p className="text-sm text-red-500">{errors.quantity_on_hand.message}</p>}
        </div>
