...
import { useStockReceipts, useCreateStockReceipt, useUpdateStockReceipt, useDeleteStockReceipt } from '../../hooks/useStore';
...
const StockReceiptsPage = () => {
  ...
  const { data, isLoading, error, refetch } = useStockReceipts(filters);
