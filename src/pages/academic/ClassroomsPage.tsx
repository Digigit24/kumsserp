...
import { useClassrooms, useDeleteClassroom } from '../../hooks/useAcademic';
...
export default function ClassroomsPage() {
    ...
    return (
        <div className="p-4 md:p-6 animate-fade-in">
            <DataTable
                title="Classrooms"
                description="Manage classrooms and their availability. Click on any row to edit."
                data={data}
                columns={columns}
                isLoading={isLoading}
                error={error}
            ...
            <DetailSidebar
                ...
                mode={sidebarMode}
            >
                {sidebarMode === 'edit' && selectedClassroom && (
