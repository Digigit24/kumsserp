...
export const NotificationRulesPage = () => {
  ...
  const { data, isLoading, refetch } = useNotificationRules(filters);
  ...
  const handleSubmit = async (formData: any) => {
    try {
      ...
      toast.error(error.message || 'Failed to save notification rule');
    }
  };
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      toast.error(error.message || 'Failed to delete notification rule');
    }
  };
