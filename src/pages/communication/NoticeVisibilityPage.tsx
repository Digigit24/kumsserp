...
export const NoticeVisibilityPage = () => {
  ...
  const { data, isLoading, refetch } = useNoticeVisibilities(filters);
  ...
  const handleSubmit = async (formData: any) => {
    try {
      ...
      toast.error(error.message || 'Failed to save notice visibility');
    }
  };
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      toast.error(error.message || 'Failed to delete notice visibility');
    }
  };
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 mt-1">Control who can see each notice</p>
        </div>
        ...
        <div className="p-6">
          {isLoading ? (
            <div className="text-center py-12">
              <p className="text-gray-500">Loading visibility rules...</p>
            </div>
