...
export const StudentAddressesPage = () => {
  const [filters, setFilters] = useState<StudentAddressFilters>({ page: 1, page_size: 20 });
  const { data, isLoading, error, refetch } = useStudentAddresses(filters);

  return (
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-3xl font-bold mb-2">Student Addresses</h1>
        <p className="text-gray-600">List of all student addresses (Permanent, Current, Hostel)</p>
      </div>
