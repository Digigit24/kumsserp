 ...
 * Displays all student promotions from API
 */

import { useState } from 'react';
import { useStudentPromotions } from '../../hooks/useStudents';
import type { StudentPromotionFilters } from '../../types/students.types';
...
export const StudentPromotionsPage = () => {
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-3xl font-bold mb-2">Student Promotions</h1>
        <p className="text-gray-600">List of all student promotions from one class to another</p>
      </div>
      ...
      {isLoading && (
        <div className="text-center py-8">
          <p className="text-lg">Loading student promotions...</p>
        </div>
      )}
