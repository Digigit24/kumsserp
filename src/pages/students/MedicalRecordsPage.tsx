...
export const MedicalRecordsPage = () => {
  const [filters, setFilters] = useState<StudentMedicalRecordFilters>({ page: 1, page_size: 20 });
  const { data, isLoading, error, refetch } = useStudentMedicalRecords(filters);

  return (
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-3xl font-bold mb-2">Student Medical Records</h1>
        <p className="text-gray-600">List of all student medical records</p>
      </div>
