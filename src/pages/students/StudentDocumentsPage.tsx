...
export const StudentDocumentsPage = () => {
  const [filters, setFilters] = useState<StudentDocumentFilters>({ page: 1, page_size: 20 });
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600">List of all student documents (Certificates, ID Proofs, etc.)</p>
      </div>
