...
const CreateTestPage = () => {
  ...
  const handleSaveAsDraft = () => {
    console.log('Saving as draft:', { ...testPaper, questions });
  ...
  const handleSendToStore = () => {
    ...
    console.log('Sending to store:', { ...testPaper, questions });
    alert(`Test paper sent to store for printing ${testPaper.print_count} copies!`);
  };
