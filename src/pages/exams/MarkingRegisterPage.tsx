...
const MarkingRegisterPage = () => {
  ...
  const handleSave = () => {
    console.log('Saving progress:', currentSheet);
    setIsDirty(false);
  ...
  const handleFinalize = () => {
    ...
    if (!allMarked) {
      alert('Please mark all questions before finalizing!');
      return;
    }
    ...
    console.log('Finalizing marks:', {
      ...currentSheet,
      total_marks_obtained: totals.obtained,
    ...
    setIsDirty(false);
    alert('Marks finalized successfully! Moving to next student...');
    handleNextStudent();
  };
  ...
  const handleGenerateMarksheet = () => {
    ...
    if (marksheet) {
      console.log('Generating marksheet:', marksheet);
      alert(`Marksheet generated for ${currentSheet.student_name}!\nTotal: ${marksheet.total_marks_obtained}/${marksheet.total_max_marks}\nPercentage: ${marksheet.overall_percentage}%\nGrade: ${marksheet.overall_grade}`);
    } else {
      alert('Marksheet data not available for this student.');
    }
  };
