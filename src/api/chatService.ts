...
export const chatAPI = {
  ...
  getConversations: async (): Promise<Conversation[]> => {
    try {
      const response = await apiClient.get<Conversation[]>('/communication/chats/conversations/');
  ...
  sendMessage: async (
    ...
    try {
      ...
      if (attachment) {
        ...
        response = await apiClient.post<Message>('/communication/chats/', formData, {
          headers: {
        ...
        // Send text message
        response = await apiClient.post<Message>('/communication/chats/', {
   ...
   */
  markAsRead: async (options: MarkAsReadOptions): Promise<MarkAsReadResponse> => {
    try {
   ...
   */
  markConversationAsRead: async (conversationId: number): Promise<MarkAsReadResponse> => {
   ...
   */
  markMessagesAsRead: async (messageIds: number[]): Promise<MarkAsReadResponse> => {
   ...
   */
  sendTyping: async (receiverId: number, isTyping: boolean): Promise<{ success: boolean }> => {
    try {
      const response = await apiClient.post<{ success: boolean }>(
        '/communication/chats/typing/',
        {
          receiver_id: receiverId,
          is_typing: isTyping,
        }
