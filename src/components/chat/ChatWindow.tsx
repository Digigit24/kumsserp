...
export const ChatWindow: React.FC<ChatWindowProps> = ({ otherUser }) => {
  ...
  const handleSSEMessage = useCallback(
    (event: SSEEvent) => {
      ...
      switch (eventType) {
        ...
        case 'notification':
          console.log('[ChatWindow] Notification:', data);
          break;

        case 'heartbeat':
          console.log('[ChatWindow] Heartbeat received');
          break;

        default:
          console.log('[ChatWindow] Unknown event:', eventType, data);
      }
    },
  ...
  return (
    <div className="chat-window flex flex-col h-full bg-white">
      {/* Chat Header */}
      <div className="chat-header flex items-center justify-between p-4 border-b border-gray-200 bg-gray-50">
