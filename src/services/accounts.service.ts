...
export const userApi = {
   ...
   */
  list: async (filters?: UserFilters): Promise<PaginatedResponse<UserListItem>> => {
   ...
   * Change password
   */
  changePassword: async (data: PasswordChangeInput): Promise<{ message: string }> => {
    return fetchApi<{ message: string }>(buildApiUrl(API_ENDPOINTS.users.changePassword), {
      method: 'POST',
      body: JSON.stringify(data),
    });
  },
  ...
  bulkDelete: async (data: BulkDeleteInput): Promise<BulkDeleteResponse> => {
    return fetchApi<BulkDeleteResponse>(buildApiUrl(API_ENDPOINTS.users.bulkDelete), {
      method: 'POST',
      body: JSON.stringify(data),
    });
  },
   ...
   */
  bulkActivate: async (data: BulkActivateInput): Promise<{ message: string; updated_ids: string[] }> => {
   ...
   */
  bulkUpdateType: async (data: BulkUserTypeUpdateInput): Promise<{ message: string; updated_ids: string[] }> => {
    return fetchApi<{ message: string; updated_ids: string[] }>(
  ...
  byType: async (type: string): Promise<UserListItem[]> => {
    return fetchApi<UserListItem[]>(buildApiUrl(API_ENDPOINTS.users.byType(type)));
  },
};
...
export const roleApi = {
   ...
   * List all roles
   */
  list: async (filters?: RoleFilters): Promise<PaginatedResponse<RoleListItem>> => {
    const queryString = buildQueryString(filters || {});
...
export const userRoleApi = {
   ...
   * List all user roles
   */
  list: async (filters?: UserRoleFilters): Promise<PaginatedResponse<UserRole>> => {
    const queryString = buildQueryString(filters || {});
   ...
   */
  patch: async (id: number, data: Partial<UserRoleUpdateInput>): Promise<UserRole> => {
...
export const departmentApi = {
   ...
   */
  list: async (filters?: DepartmentFilters): Promise<PaginatedResponse<DepartmentListItem>> => {
    const queryString = buildQueryString(filters || {});
  ...
  get: async (id: number): Promise<Department> => {
    return fetchApi<Department>(buildApiUrl(API_ENDPOINTS.departments.detail(id)));
  },
   ...
   * Update department
   */
  update: async (id: number, data: DepartmentUpdateInput): Promise<Department> => {
    return fetchApi<Department>(buildApiUrl(API_ENDPOINTS.departments.update(id)), {
      method: 'PUT',
      body: JSON.stringify(data),
    });
  },
   ...
   */
  patch: async (id: number, data: Partial<DepartmentUpdateInput>): Promise<Department> => {
    return fetchApi<Department>(buildApiUrl(API_ENDPOINTS.departments.patch(id)), {
      method: 'PATCH',
      body: JSON.stringify(data),
    });
  },
...
export const userProfileApi = {
   ...
   */
  list: async (filters?: UserProfileFilters): Promise<PaginatedResponse<UserProfile>> => {
    const queryString = buildQueryString(filters || {});
  ...
  get: async (id: number): Promise<UserProfile> => {
    return fetchApi<UserProfile>(buildApiUrl(API_ENDPOINTS.userProfiles.detail(id)));
  },
  ...
  create: async (data: UserProfileCreateInput): Promise<UserProfile> => {
    return fetchApi<UserProfile>(buildApiUrl(API_ENDPOINTS.userProfiles.create), {
      method: 'POST',
      body: JSON.stringify(data),
    });
  },
   ...
   * Update user profile
   */
  update: async (id: number, data: UserProfileUpdateInput): Promise<UserProfile> => {
    return fetchApi<UserProfile>(buildApiUrl(API_ENDPOINTS.userProfiles.update(id)), {
      method: 'PUT',
      body: JSON.stringify(data),
    });
  },
   ...
   */
  patch: async (id: number, data: Partial<UserProfileUpdateInput>): Promise<UserProfile> => {
    return fetchApi<UserProfile>(buildApiUrl(API_ENDPOINTS.userProfiles.patch(id)), {
      method: 'PATCH',
      body: JSON.stringify(data),
    });
  },
