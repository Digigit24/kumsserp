...
- `/api/v1/store/procurement/requirements/`: Manage procurement needs.
- `/api/v1/store/procurement/quotations/`: Manage vendor quotes.
- `/api/v1/store/procurement/purchase-orders/`: PO management (includes PDF generation).
- `/api/v1/store/procurement/goods-receipts/`: Goods receipt and posting to inventory.
- `/api/v1/store/indents/`: Internal requests and approval actions.
- `/api/v1/store/material-issues/`: Issuing items from central store.
...
- **Material Issue**: `generate_gate_pass()`, `mark_dispatched()`, `mark_received()`.
